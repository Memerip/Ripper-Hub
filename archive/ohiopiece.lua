...
local Window = OrionLib:MakeWindow({Name = "Ripper Hub - Ohio Piece", HidePremium = true, IntroText = "Ripper Hub", SaveConfig = true, ConfigFolder = "RipperHubapiece"})
...
HomeTab:AddParagraph("Supported Game", "Ohio Piece")
...
InfoTab:AddParagraph("Ohio Piece", "Verison 1.0")
